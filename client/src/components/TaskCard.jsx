...
export default function TaskCard({ task }) {
  ...
  return (
    <div className="task-card bg-surface-container-lowest border border-outline-variant rounded-lg p-3 shadow-sm transition-all cursor-grab active:cursor-grabbing hover:border-primary">
      {/* Header */}
      ...
      {/* Title */}
      <h3 className="text-body-base font-medium text-on-surface leading-tight mb-3">
        {task.title}
      </h3>
